...
export const HelpCircleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg>
);
...
export const ArrowLeftIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 19-7-7 7-7"></path><path d="M19 12H5"></path></svg>
);
...
export const XCircleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><path d="m15 9-6 6"></path><path d="m9 9 6 6"></path></svg>
);
...
export const OnboardingWelcomeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 140" {...props}>
        <rect width="200" height="140" fill="#F4F5F7" rx="10"/>
        <path d="M40 110 H160 V120 H40z" fill="#E5E7EB"/>
        <rect x="20" y="20" width="160" height="80" rx="5" fill="#FFFFFF" stroke="#D1D5DB" strokeWidth="2"/>
        <path d="M35 35 H90" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round"/>
        <path d="M35 45 H110" stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round"/>
        <path d="M35 55 H100" stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round"/>
        <path d="M35 70 H70" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round"/>
        <path d="M35 80 H120" stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round"/>
        <circle cx="140" cy="57" r="18" fill="#3B82F6"/>
        <path d="M134 57 L139 62 L148 53" stroke="white" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);

export const OnboardingSuccessIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" {...props}>
        <circle cx="50" cy="50" r="48" fill="#ECFDF5" stroke="#10B981" strokeWidth="3"/>
        <path d="M30 50 L45 65 L75 35" stroke="#10B981" strokeWidth="8" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 3L9.27 7.76L4 9l4.76 4.73L7.53 19l4.47-2.34L16.47 19l-1.23-5.27L20 9l-5.27-1.24L12 3zM21 12l-1.76 1.76l1.76 1.77M3 12l1.76-1.76L3 8.47"/></svg>
);
